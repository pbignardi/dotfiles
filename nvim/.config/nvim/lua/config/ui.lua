...
MiniDeps.later(function()
  ...
  vim.keymap.set("n", "<leader>fgd", ":Pick git_hunks<CR>", { desc = "hunks" })
  vim.keymap.set("n", "<leader>fgb", ":Pick git_branches<CR>", { desc = "branches" })
  vim.keymap.set("n", "<leader>fgc", ":Pick git_commits<CR>", { desc = "commits" })
